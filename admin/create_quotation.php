...
<div class="page-header">
    <div>
        <h1><i class="fas fa-file-alt"></i> Create Quotation</h1>
...
<div id="nts" class="tab">
    <div class="form-group">
        ...
        <div id="notesEditor" style="height: 200px; background: #fff; font-family: inherit; border-radius: 0 0 8px 8px;">
            <p><strong>Project Overview:</strong></p>
            <p><br></p>
            <p><strong>Important Notes:</strong></p>
            <ul>
                <li>The total price is exclusive of any taxes and other applicable fees.</li>
                <li>Timeline commences upon receipt of advance payment and required assets.</li>
            </ul>
        </div>
...
<div id="sig" class="tab">
    ...
    <div class="info-tip">
        <i class="fas fa-lightbulb"></i> After saving, a <strong>PDF is automatically generated</strong> and can be downloaded from the quotation details page.
    </div>
</div>
...
<div class="form-actions">
    ...
    <button type="submit" class="btn btn-primary"   id="subBtn"  style="display:none;"><i class="fas fa-check"></i> Save & Generate PDF</button>
</div>
</form>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    if (typeof Quill !== 'undefined') {
        ...
        // Set initial value so it captures the default text
