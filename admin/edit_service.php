...
<div class="height-100">
    <div class="page-header">
        <h1><i class="fas fa-pencil-alt"></i>️ Edit Service</h1>
        ...
        <form method="POST" enctype="multipart/form-data" id="serviceForm">
                ...
                <div id="packagesWrapper">
                    ...
                    <div class="pkg-card" id="pkg-<?= $i ?>">
                        <div class="pkg-card-header">
                            <h4><i class="fas fa-box"></i> Package <?= $i + 1 ?></h4>
                            <button type="button" class="pkg-remove-btn" onclick="removePackage('pkg-<?= $i ?>')" title="Remove package"><i class="fas fa-times"></i></button>
                        </div>
                        ...
                        <div id="features-<?= $i ?>">
                            ...
                            <div class="pkg-feature-row" id="feat-<?= $i ?>-<?= $fi ?>">
                                ...
                                <button type="button" class="pkg-feature-remove"
                                        onclick="removeFeature('feat-<?= $i ?>-<?= $fi ?>')" title="Remove"><i class="fas fa-times"></i></button>
                            </div>
                            <?php endforeach; ?>
                        </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary" id="submitBtn" style="display:none;">
                    <span><i class="fas fa-check"></i></span> Save Changes
                </button>
            </div>
