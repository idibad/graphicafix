...
<div class="ms-tabs-container">
    ...
    <!-- Tab Buttons -->
    <div class="ms-tabs">
        <button class="ms-tab active" onclick="switchTab(event, 'ms-services')" >
            Services
            <span class="ms-tab-badge"><?php echo $service_stats['active_services'] ?? 0; ?></span>
        </button>

        <button class="ms-tab" onclick="switchTab(event, 'ms-discounts')">
            Discounts
            <span class="ms-tab-badge"><?php echo $discount_stats['active_discounts'] ?? 0; ?></span>
        </button>

        <button class="ms-tab" onclick="switchTab(event, 'ms-announcements')">
            Announcements
            <span class="ms-tab-badge"><?php echo $announcements_count ?? 0; ?></span>
        </button>
    </div>
    ...
    <div class="ms-tab-contents">
        ...
        <!-- Services Tab -->
        <div id="ms-services" class="ms-tab-content active" style="display:block;">
        ...
        <!-- Discounts Tab -->
        <div id="ms-discounts" class="ms-tab-content" style="display:none;">
        ...
        <!-- Announcements Tab -->
        <div id="ms-announcements" class="ms-tab-content" style="display:none;">
