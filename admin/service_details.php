...
<div class="height-100">
        ...
        <div class="header-details-top">
            <div class="header-content">
                ...
                <div class="client-name">
                    ...
                    <span><i class="fas fa-shopping-cart"></i></span> <?= (int)$service['orders_count'] ?> Orders
                </div>
            </div>
            <div class="header-actions">
                ...
                <button class="btn btn-secondary" onclick="window.location='edit_service.php?id=<?= $service_id ?>'">
                    <span><i class="fas fa-pencil-alt"></i>️</span> Edit
                </button>
                <button class="btn btn-primary" onclick="window.location='edit_service.php?id=<?= $service_id ?>'">
                    <span><i class="fas fa-plus"></i></span> Add Package
                </button>
            </div>
        </div>
    ...
    <div class="content-grid">
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-edit"></i> Service Description</h2>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-box"></i> Packages</h2>
                    ...
                    <div class="packages-grid">
                        ...
                        <div class="pkg-detail-card <?= $pkg['is_featured'] ? 'pkg-featured' : '' ?>">
                            ...
                            <?php if ($pkg['is_featured']): ?>
                                <div class="pkg-featured-ribbon"><i class="fas fa-star"></i> Featured</div>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($pkg['features'])): ?>
                                <ul class="pkg-detail-features">
                                    <?php foreach ($pkg['features'] as $feat): ?>
                                        <li>
                                            <span class="feat-check"><i class="fas fa-check"></i></span>
                            ...
                            <div class="pkg-detail-footer">
                                ...
                                <div style="display:flex;gap:8px;">
                                    <button class="btn btn-secondary"
                                        ...
                                        <i class="fas fa-pencil-alt"></i>️ Edit
                                    </button>
        ...
        <div class="sidebar">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-chart-bar"></i> Stats</h2>
                </div>
                <div class="timeline">
            ...
            <div class="card">
                ...
                <div style="display:flex;flex-direction:column;gap:8px;">
                    <button class="btn btn-secondary" style="width:100%;justify-content:center;"
                        ...
                        <i class="fas fa-pencil-alt"></i>️ Edit Service
                    </button>
                    <button class="btn btn-secondary" style="width:100%;justify-content:center;"
