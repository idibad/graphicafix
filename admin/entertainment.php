...
<!-- ── Hero ─────────────────────────────────────────────────── -->
<div class="ent-hero">
    <div class="ent-tag"><i class="fas fa-bolt"></i> Break Room</div>
    <h1 class="ent-h1">GAME <span>ZONE</span></h1>
    <div class="pb-strip">
        <div class="pb-chip"><i class="fas fa-circle text-danger"></i> MY BRICK BEST <span id="myBrickBest"><?= $myBrick ?: '—' ?></span></div>
        <div class="pb-chip"><i class="fas fa-rocket"></i> MY DODGE BEST <span id="myDodgeBest"><?= $myDodge ?: '—' ?></span></div>
    </div>
</div>
...
<div class="games-grid">
    ...
    <div class="game-card game-brick">
        <div class="gc-header">
            <div class="gc-title-row">
                <span class="gc-icon"><i class="fas fa-circle text-danger"></i></span>
    ...
    <div class="game-card game-dodge">
        <div class="gc-header">
            <div class="gc-title-row">
                <span class="gc-icon"><i class="fas fa-rocket"></i></span>
    ...
    <div class="lb-grid">
        ...
        <div class="lb-card game-brick">
            <div class="lb-card-head">
                <div class="lb-card-title"><i class="fas fa-circle text-danger"></i> BRICK BREAKER</div>
        ...
        <div class="lb-card game-dodge">
            <div class="lb-card-head">
                <div class="lb-card-title"><i class="fas fa-rocket"></i> ASTEROID DODGE</div>
...
function addLeaderboardRow(prefix, score) {
    ...
    tr.innerHTML = `
        <td class="medal"><i class="fas fa-star"></i></td>
...
(function(){
    ...
    function tick(){
        ...
        if(left===0){endGame('You Won! <i class="fas fa-tada"></i>');return;}
