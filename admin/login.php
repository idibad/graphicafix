...
/* Ensure the input takes full width but leaves padding on the right for the button */
...
/* Position the button absolutely inside the wrapper */
.toggle-password-btn {
    position: absolute;
    right: 12px;
    top: 50%;
...
/* Optional: Removes the default outline when clicking the toggle button */
               ...
               <form method="POST">
                    ...
                    <div class="password-wrapper">
                        <input type="password" 
                               ...
                               class="<?= !empty($error_message) ? 'error' : '' ?>"
                               required>
                        <button type="button" id="togglePassword" class="toggle-password-btn"><i class="fas fa-eye"></i></button>
                    </div>
                
                    <input type="submit" name="login" value="Sign In" class="main-btn" style="margin-top: 15px;">
                </form>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const icon = togglePassword.querySelector('i'); // Target the Font Awesome icon
