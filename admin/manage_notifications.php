...
<div class="height-100">
    ...
    <div class="notif-stats-row">
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#f0f9f8;color:#024442;"><i class="fas fa-bell"></i></div>
        ...
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#fff5f5;color:#e53e3e;"><i class="fas fa-circle text-danger"></i></div>
            <div class="notif-stat-info">
        ...
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#f0f9f8;color:#024442;"><i class="fas fa-clipboard"></i></div>
            <div class="notif-stat-info">
        ...
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#f5f3ff;color:#7c3aed;"><i class="fas fa-briefcase"></i></div>
            <div class="notif-stat-info">
        ...
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#f0f9ff;color:#0ea5e9;"><i class="fas fa-envelope"></i>️</div>
            <div class="notif-stat-info">
        ...
        <div class="notif-stat-card">
            <div class="notif-stat-icon" style="background:#fffbeb;color:#d97706;"><i class="fas fa-star"></i></div>
            <div class="notif-stat-info">
        ...
        <div class="notif-toolbar">
            <div class="notif-filter-btns">
                ...
                $filters = [
                    ...
                    'project_request'    => ['<i class="fas fa-clipboard"></i> Requests', $prCount],
                    'career_application' => ['<i class="fas fa-briefcase"></i> Applications', $caCount],
                    'contact'            => ['<i class="fas fa-envelope"></i>️ Messages', $ctCount],
                    'review'             => ['<i class="fas fa-star"></i> Reviews', $rvCount],
                ];
            ...
            <div class="notif-actions-btns">
                ...
                <a href="manage_notifications.php?action=delete_all_read"
                   ...
                   onclick="return confirm('Delete all read notifications?')">
                    <i class="fas fa-trash"></i>️ Clear Read
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="padding:0;overflow:hidden;">
        <?php if ($notifs && $notifs->num_rows > 0): ?>
            ...
            <div class="notif-row <?= !$n['is_read'] ? 'notif-row-unread' : '' ?>">
                ...
                <div class="notif-row-body">
                    ...
                    <div class="notif-row-time"><i class="fas fa-clock"></i> <?= date('M d, Y · h:i A', strtotime($n['created_at'])) ?> &nbsp;·&nbsp; <?= timeAgo($n['created_at']) ?></div>
                </div>
        ...
        <?php else: ?>
            <div class="empty-state" style="padding:3rem;">
                <div class="empty-icon"><i class="fas fa-tada"></i></div>
